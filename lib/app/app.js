...
var App = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.pubSub.unsubscribe()];
                    case 1:
                        _a.sent();
                        process.exit();
                        return [2];
    ...
    App.prototype.executeScript = function (config) {
        child_process.exec("bash " + config.shellScript, function (error, stdout, stderr) {
            if (error) {
    ...
    App.prototype.init = function () {
        this.pubSub = new pubSub_service_1.PubSubService(this.config.keyFile, this.config.projectId, this.config.subId);
    };
    return App;
}());
exports.App = App;
